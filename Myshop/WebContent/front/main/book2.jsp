...
%>
<%
          Book2Dao itemsDao=new Book2Dao();
          Book2 book = itemsDao.getBookById(Integer.parseInt(request.getParameter("id")));
          if(book!=null){
    %>
<!DOCTYPE html>
<html>
	...
	<div class="book1 clearfix commonWidth">
        ...
        <div class="book1-buy">
	       	<div class="pic fl">
	       		<img src="../img/book1/<%=book.getBigPicture() %>.jpg" />
	        </div>
		...
		<div class="fr book-introduce" id="book">
		    ...
		    <div class="book-detail" id="book-c">
		    	<div class="book-a bo1">
        		    ...
        		    <span class="book-in author-in clearfix">
        		    	<h4>作者简介：</h4>
        		    	<p>  
        		    	<%=book.getAuthorin() %>
        		    	</p>
